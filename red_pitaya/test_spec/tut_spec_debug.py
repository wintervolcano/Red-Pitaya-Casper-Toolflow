...
fpga.snapshots.accum0_snap_ss.arm(circular_capture=True)
spec0=fpga.snapshots.accum0_snap_ss.read(arm=False)['data']

fpga.snapshots.accum1_snap_ss.arm(circular_capture=True)
spec1=fpga.snapshots.accum1_snap_ss.read(arm=False)['data']

fpga.snapshots.accumdat_snap_ss.arm(circular_capture=True)
spec_dat=fpga.snapshots.accumdat_snap_ss.read(arm=False)['data']


fig0, ax0= plt.subplots()
#print(len(spec0['P_acc0']))
#print(spec0['P_acc0'][512:513])
